  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        {/* Right Content */}
        <div>
          <h2 className="text-4xl lg:text-5xl font-bold leading-tight mb-6 ml-20">
            Why{" "}
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-4 ml-20">
            SEO evolves in every single day. My approach is built on staying
            ahead of these changes, combining data, user intent, and create
